...
def test_book_reference():
    ...
    assert fmt.format(ref, FORMATS.NAME_FORMAT) == "Big Book"


def test_book_range():
    ref = reference(range(verse(1, 2, 1, 1), verse(1, 3, 999, 999)))

    assert fmt.format(ref, FORMATS.ABBREV_NAME_FORMAT) == "Big–Small"


def test_chapter_reference():
    ref = reference(range(verse(1, 2, 3, 1), verse(1, 2, 3, 999)))

    assert fmt.format(ref, FORMATS.NAME_FORMAT) == "Big Book 3"


def test_chapter_range():
    ref = reference(range(verse(1, 2, 3, 1), verse(1, 2, 4, 999)))

    assert fmt.format(ref, FORMATS.NAME_FORMAT) == "Big Book 3–4"


def test_single_range():
    ref = reference(range(verse(1, 2, 1, 1), verse(1, 2, 1, 2)))

    assert fmt.format(ref, FORMATS.NAME_FORMAT) == "Big Book 1:1–2"
    assert fmt.format(ref, FORMATS.ABBREV_NAME_FORMAT) == "Big 1:1–2"
    assert fmt.format(ref, FORMATS.NUMBER_FORMAT) == "1:1–2"
...
def test_multiple_verse_range():
    ...
    assert fmt.format(ref, FORMATS.NAME_FORMAT) == "Big Book 1:1–2, 7–9"
...
def test_inter_chapter_ranges():
    ...
    assert fmt.format(ref, FORMATS.NAME_FORMAT) == "Big Book 1:20–2:10; 3:21–4:11"
...
def test_multiple_chapter_range():
    ...
    assert fmt.format(ref, FORMATS.NAME_FORMAT) == "Big Book 1:1–2; 2:1–2"
...
def test_multiple_book_range():
    ...
    assert fmt.format(ref, FORMATS.NAME_FORMAT) == "Big Book 1:1–2; Small Book 1–2"
...
def test_multiple_library_range():
    ...
    assert fmt.format(ref, FORMATS.NAME_FORMAT) == "Big Book 1:1–2; 4 Book 2:1"
...
def test_book_chapter_equal_1():
    ...
    assert fmt.format(ref, FORMATS.NAME_FORMAT) == "Small Book 1–2"
